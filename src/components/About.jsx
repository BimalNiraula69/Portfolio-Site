  ...
  return (
    <div>
      ...
      <div className="relative w-full h-full p-4 sm:p-8">
        <h2 className="mt-5 text-2xl font-semibold"><span className="underline-custom">Abo</span>ut</h2>
